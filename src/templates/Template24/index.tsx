...
const Template24 = (props: ITemplateProps) => {
  ...
  const backgroundPath = props.isPreview
    ? "./images/template/wtm/template-bg-24-wtm.png"
    : "./images/template/template-bg-24.png";
...
export default async (data: ITemplateProps) => {
  return await ReactPDF.renderToStream(<Template24 {...data} />);
};
