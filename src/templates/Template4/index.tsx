...
const Template4 = (props: ITemplateProps) => {
  const backgroundPath = props.isPreview
    ? "/images/template/wtm/template-bg-4-wtm.png"
    : "/images/template/template-bg-4.png";
...
export default async (data: ITemplateProps) => {
  return await ReactPDF.renderToStream(<Template4 {...data} />);
};
